                        ...
                        <h3>Keep updated with what I'm up to!</h3>
                            <div Class='Socials' className="inline-flex py-2 px-4 my-6">
                                <div Class='socialcolumn'>
                                    <a href="https://www.instagram.com/ashleyjamescreative/" className="mr-4" target="_blank" rel="noreferrer noopener"><img src='https://uploads-ssl.webflow.com/5eebd8c985e3ccd7ecc96f67/5fe1e49c1539418585831163_iconfinder_SocialMedia_Instagram-Outline_2959748%402x.png' alt="Link to my Intsagram"/></a>
                                </div>
                                <div Class='socialcolumn'>
